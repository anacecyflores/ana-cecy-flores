...
const greeting = {
  ...
  subTitle: emoji(
    " AWS Solutions Architect and a passionate Full Stack Web Developer having an experience of building Web applications with JavaScript / Reactjs / Nodejs / React Native and some other libraries and frameworks.💻"
  ),
  resumeLink:
